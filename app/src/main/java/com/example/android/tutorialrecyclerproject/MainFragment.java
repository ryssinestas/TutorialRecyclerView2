...
public class MainFragment extends Fragment {
    ...
    public void onStart() {
        ...
        RecyclerView recyclerView = (RecyclerView) activity.findViewById(R.id.rvContacts);
        ComplexRecyclerViewAdapter adapter = new ComplexRecyclerViewAdapter(getSampleArrayList());
